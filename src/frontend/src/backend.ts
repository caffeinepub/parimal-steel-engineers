...
import type { Client as _Client, ContactInfo as _ContactInfo, ExternalBlob as _ExternalBlob, Project as _Project, ProjectUpdate as _ProjectUpdate, Service as _Service, UserProfile as _UserProfile, UserRole as _UserRole, WebsiteContent as _WebsiteContent, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addProject(arg0: ProjectUpdate): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addProject(await to_candid_ProjectUpdate_n8(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getContent(): Promise<WebsiteContent> {
        if (this.processError) {
            try {
                ...
                return from_candid_WebsiteContent_n17(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async updateContent(arg0: WebsiteContent): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateContent(await to_candid_WebsiteContent_n28(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateProject(arg0: bigint, arg1: ProjectUpdate): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateProject(arg0, await to_candid_ProjectUpdate_n8(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_Client_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Client): Promise<Client> {
...
async function from_candid_WebsiteContent_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _WebsiteContent): Promise<WebsiteContent> {
...
async function from_candid_record_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        heroSubheadline: value.heroSubheadline,
        materials: value.materials,
        heroHeadline: value.heroHeadline,
        services: value.services,
        companyDescription: value.companyDescription,
        clients: await from_candid_vec_n19(_uploadFile, _downloadFile, value.clients)
    };
}
...
async function from_candid_vec_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Client>): Promise<Array<Client>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Client_n20(_uploadFile, _downloadFile, x)));
}
async function from_candid_vec_n24(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Project>): Promise<Array<Project>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Project_n25(_uploadFile, _downloadFile, x)));
}
...
async function to_candid_Client_n31(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Client): Promise<_Client> {
...
async function to_candid_ProjectUpdate_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: ProjectUpdate): Promise<_ProjectUpdate> {
...
async function to_candid_WebsiteContent_n28(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: WebsiteContent): Promise<_WebsiteContent> {
...
async function to_candid_record_n29(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        services: value.services,
        companyDescription: value.companyDescription,
        clients: await to_candid_vec_n30(_uploadFile, _downloadFile, value.clients)
    };
}
...
async function to_candid_vec_n30(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<Client>): Promise<Array<_Client>> {
    return await Promise.all(value.map(async (x)=>await to_candid_Client_n31(_uploadFile, _downloadFile, x)));
}
